...
***
### Introduction
This website contains a tutorial on how to simply classify vegetation change based on [spectral imagery](B_specimg.html). These instructions are meant to be read while using the software provided along with it. This software can be found **here**. Additional information about vegetation succession, classification methods, and data types are provided for a better understanding of the underlying processess. As an example, a possible result of a classsifcation can be seen [here](GUI_results.html) 
